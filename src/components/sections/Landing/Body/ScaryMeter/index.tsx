    ...
    <section className={s.section} id="project">
      <div className={s.content}>
        ...
        <div className={s.info}>
          ...
          <li>{t('benefits.08')}<br />{t('benefits.08a')}</li>
            <li>{t('benefits.01')}</li>
            <li>{t('benefits.01a')}</li>
            <li>{t('benefits.02')} </li>
            <li>{t('benefits.03')}</li>
            <li>{t('benefits.04')}</li>
            <li>{t('benefits.05')}</li>
